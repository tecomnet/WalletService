...
{
    /// <summary>
    /// Estructura para actualizar una empresa
    /// </summary>
    [DataContract]
    public partial class EmpresaUpdateRequest : IEquatable<EmpresaUpdateRequest>
    { 
        /// <summary>
        /// Gets or Sets Nombre
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append(value: "class EmpresaUpdateRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals(other: (EmpresaUpdateRequest)obj);
        }

        /// <summary>
        /// Returns true if EmpresaUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of EmpresaUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmpresaUpdateRequest other)
        {
        ...
        public static bool operator ==(EmpresaUpdateRequest left, EmpresaUpdateRequest right)
        {
