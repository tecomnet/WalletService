...
namespace Wallet.RestAPI.Models
{
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TarjetaVinculadaResult {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PanEnmascarado: ").Append(PanEnmascarado).Append("\n");
            sb.Append("  Alias: ").Append(Alias).Append("\n");
            sb.Append("  Marca: ").Append(Marca).Append("\n");
            sb.Append("  EsFavorita: ").Append(EsFavorita).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TarjetaVinculadaResult)obj);
        }

        /// <summary>
        /// Returns true if TarjetaVinculadaResult instances are equal
        /// </summary>
        /// <param name="other">Instance of TarjetaVinculadaResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TarjetaVinculadaResult other)
        {
            ...
            return 
                ...
                (
                    ...
                    EsFavorita != null &&
                    EsFavorita.Equals(other.EsFavorita)
                ) && 
                (
                    Guid == other.Guid ||
                    Guid != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (EsFavorita != null)
                    hashCode = hashCode * 59 + EsFavorita.GetHashCode();
                    if (Guid != null)
        ...
        public static bool operator ==(TarjetaVinculadaResult left, TarjetaVinculadaResult right)
        {
