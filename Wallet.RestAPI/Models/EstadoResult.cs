...
{
    /// <summary>
    /// Estructura retorna estados de la repuplica mexicana
    /// </summary>
    [DataContract]
    public partial class EstadoResult : IEquatable<EstadoResult>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append(value: "class EstadoResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals(other: (EstadoResult)obj);
        }

        /// <summary>
        /// Returns true if EstadoResult instances are equal
        /// </summary>
        /// <param name="other">Instance of EstadoResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstadoResult other)
        {
        ...
        public static bool operator ==(EstadoResult left, EstadoResult right)
        {
