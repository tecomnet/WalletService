...
public class ProveedorApiController : ProveedorApiControllerBase
{
    ...
    /// <inheritdoc/>
    public override async Task<IActionResult> ActualizarProveedorServicio(
    ...
    /// <inheritdoc/>
    public override async Task<IActionResult> EliminarProveedorServicioAsync(
    ...
    /// <inheritdoc/>
    public override async Task<IActionResult> ObtenerProveedorServicioPorIdAsync(
        [FromRoute] [Required] int? idProveedor)
    {
        if (idProveedor == null)
        {
    ...
    /// <inheritdoc/>
    public override async Task<IActionResult> ObtenerProveedoresAsync()
    {
    ...
    /// <inheritdoc/>
    public override async Task<IActionResult> CrearProveedor([FromBody] ProveedorRequest body)
    {
