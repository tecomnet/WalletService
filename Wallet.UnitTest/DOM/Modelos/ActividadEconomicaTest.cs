...
public class ActividadEconomicaTest : UnitTestTemplate
{
    ...
    [InlineData("1. OK: Full Valid",
        "Mi Actividad Principal", 1500.75, "Ventas Online", "s3://ruta/archivo_valido.pdf",
        true, new string[] { })]
    ...
    [InlineData("4. ERROR: Nombre null",
        null, 100.00, "Ventas", "s3://ruta/archivo.pdf",
    ...
    [InlineData("7. ERROR: Ingreso cero",
        "Ventas", 0.00, "Ventas", "s3://ruta/archivo.pdf",
        false, new string[] { "PROPERTY-VALIDATION-ZERO-INVALID" })] // allowZero: false
    [InlineData("8. ERROR: Ingreso negativo",
        "Ventas", -10.50, "Ventas", "s3://ruta/archivo.pdf",
        false, new string[] { "PROPERTY-VALIDATION-NEGATIVE-INVALID" })] // allowNegative: false
    [InlineData("9. ERROR: Ingreso con 3 decimales",
        "Ventas", 100.123, "Ventas", "s3://ruta/archivo.pdf",
        false, new string[] { "PROPERTY-VALIDATION-DECIMALS-INVALID" })] // allowedDecimals: 2

    // CASOS DE ERROR PARA ORIGEN RECURSO (string, min 1, max 100)
    [InlineData("10. ERROR: OrigenRecurso null",
    ...
    [InlineData("12. ERROR: ArchivoAWS null",
        "Ventas", 100.00, "Ventas", null,
        false, new string[] { "PROPERTY-VALIDATION-REQUIRED-ERROR" })]
    [InlineData("13. ERROR: ArchivoAWS empty",
