...
#pragma warning disable CS8604 // Possible null reference argument
    ...
    [InlineData(data:
    [
        "1. OK: Todos los campos válidos", "Ana", "Lopez", "Gomez", "1990-01-01", Genero.Femenino, true,
        new string[] { }
    ])]
    [InlineData(data:
    [
        "2. OK: Segundo Apellido null", "Juan", "Perez", "Gomez", "2000-05-15", Genero.Masculino, true, new string[] { }
    ])]
    [InlineData(data:
    [
        "3. OK: Longitud máxima (Nombre/Apellido y Email)",
    ...
    [InlineData(data:
    [
        "9. ERROR: Múltiples fallos críticos", "",
    ...
    [InlineData(data:
    [
        "1. OK: CrearContrasena", "CrearContrasena", "NuevaPass123", null, null, null, null, null, true,
        new string[] { }
    ])]
    [InlineData(data:
    [
        "2. OK: ActualizarContrasena", "ActualizarContrasena", "SuperNuevaPass", "SuperNuevaPass", ContrasenaInicial,
        null, null, null, true, new string[] { }
    ])]
    [InlineData(data:
    [
        "3. OK: ActualizarTelefono", "ActualizarTelefono", null, null, null, "MEX", "5512345678", null, true,
        new string[] { }
    ])]
    [InlineData(data:
    [
        "4. OK: ActualizarCorreo", "ActualizarCorreoElectronico", null, null, null, null, null,
        "nuevo.email@ejemplo.com", true, new string[] { }
    ])]
    [InlineData(data:
    [
        "5. OK: Longitud máxima Contraseña (100)", "CrearContrasena",
    ...
    [InlineData(data:
    [
        "6. ERROR: Pass Antigua NO Coincide", "ActualizarContrasena", "SuperNuevaPass", "SuperNuevaPass",
        "PassIncorrecta", null, null, null, false, new string[] { ServiceErrorsBuilder.ContrasenaActualIncorrecta }
    ])]
    [InlineData(data:
    [
        "6.1. ERROR: Pass Antigua NO Coincide", "ActualizarContrasena", "SuperNuevaPass", "SuperNuevaPass1",
        "PassIncorrecta", null, null, null, false, new string[] { ServiceErrorsBuilder.ContrasenasNoCoinciden }
    ])]
    // === ERRORES DE CONTRASENA (REQUIRED, LENGTH-INVALID) ===
    [InlineData(data:
        ["7. OK: Contrasena nula", "CrearContrasena", null, null, null, null, null, null, true, new string[] { }])]
    [InlineData(data:
    [
    ...
    [InlineData(data:
    [
        "13. OK: Correo null", "ActualizarCorreoElectronico", null, null, null, null, null, null, true, new string[] { }
    ])]
    [InlineData(data:
    [
    ...
    [InlineData(data:
    [
        "16. ERROR: Múltiples fallos en Teléfono", "ActualizarTelefono", null, null, null, "M", "",
