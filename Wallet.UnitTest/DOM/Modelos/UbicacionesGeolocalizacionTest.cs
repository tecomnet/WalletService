...
// Constantes de datos para casos límite y errores
    ...
    [InlineData("1. OK: Datos mínimos válidos",
        ...
        true, new string[] { })]
    [InlineData("2. OK: Latitud/Longitud compleja y Máx 100",
        "89.99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999", // 100 chars (Lat)
        "-179.99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999", // 99 chars (Long)
        Dispositivo.Web,
    ...
    // ----------------------------------------------------------------------------------------------------------------
    [InlineData("9. ERROR: Latitud > 100 caracteres",
        Max100Chars + "X", LatLongValid, Dispositivo.App, "Login", "Mobile", "Chrome", IpV4Valid, 
    ...
    [InlineData("12. ERROR: Múltiples fallos críticos",
        "", "", Dispositivo.App, null, "", Max100Chars + "X", "",
        false, new string[] { 
    ...
    )
    {
        try
        {
            ...
            Assert.Equal(latitud, ubicacion.Latitud);
            Assert.Equal(longitud, ubicacion.Longitud);
